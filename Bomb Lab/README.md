...
9 15 14 5 6 7
```
我们再把偏移值作为[ASCII]()字符的低四位，构造成可输入的字符。我这里是分别加上80(01010000)，构成第五个字符串`Y_^UVW`。
...
## Recitation Video
https://www.youtube.com/watch?v=rb-RNYhHNSc&list=PL4YtNpAhVHFJVlaD203_8JkUOUT8RYUhY&index=29
